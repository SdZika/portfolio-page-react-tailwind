...
export const Blog = () => {
  return (
    <div className="max-w-[1200px] mx-auto py-12" id="blog">
      <div className="pb-8">
        <p className="text-4xl mb-3 font-bold primary-color">Blog</p>
        <p className="text-gray-400">Check out some of my recent blogs</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <article className="bg-[#161616] p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
